...
import { default as gestureItems } from './gesture/_items.js';
    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <Block name='Basic' ccname='基础' color='#5e83dd'>
          <Category navigation={this.props.navigation} items={basicItems}></Category>
        </Block>
        <Block name='Business' ccname='业务相关' color='#83d23a'>
          <Category navigation={this.props.navigation} items={businessItems}></Category>
        </Block>
        <Block name='Feedback' ccname='操作反馈' color='#ff7a2e'>
          <Category navigation={this.props.navigation} items={feedbackItems}></Category>
        </Block>
        <Block name='Form' ccname='表单相关' color='#ffc013'>
          <Category navigation={this.props.navigation} items={formItems}></Category>
        </Block>
        <Block name='Gesture' ccname='手势' color='#ff525d'>
          <Category navigation={this.props.navigation} items={gestureItems}></Category>
        </Block>
      </ScrollView>
    );
  }
