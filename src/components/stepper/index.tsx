...
export interface IMDStepperProps {
...
export interface IMDStepperStyle {
  wrapper?: ViewStyle;
  button?: ViewStyle;
...
const enableColor = '#41485D';
const disableColor = '#4C41485D';
      ...
      <View style={_styles.wrapper}>
        ...
        >
          <View style={[_styles.button]}>
            <MDIcon
              name='sub'
              color={disabled || isMin ? disableColor : enableColor}
              size={stepper.widthIcon}
              svg={true}
            />
          </View>
        </TouchableOpacity>
        ...
        >
          <View style={[_styles.button]}>
            <MDIcon
              name='add'
              color={disabled || isMax ? disableColor : enableColor}
              size={stepper.widthIcon}
              svg={true}
            />
          </View>
